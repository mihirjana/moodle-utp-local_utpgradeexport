...
$string['csvlocationdesc'] = 'Full server path where CSV files should be created. This directory must be writable by the web user';
...
$string['ismanual'] = 'Is Grade Export manual?';
...
$string['isnotmanual'] = 'The manual UTP Grade Export is unavailable, you will be redirected to change the settings';
$string['lastname'] = 'Lastname';
$string['local/utpgradeexport:config'] = 'Configure UTP Grade Export';
$string['manualexport'] = 'Manual Export';
$string['manualexportheader'] = 'Manually Export UTP Grades';
$string['notattempted'] = 'Not Attempted';
$string['percentageresult'] = '% Result';
$string['pluginname'] = 'UTP Grade Export';
